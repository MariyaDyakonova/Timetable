...
namespace TimeTableProject
{
    public class Queries
    {
        ...
        public static string selectDisciplineForOneGroup = "SELECT discipline.Discipline_ID, discipline.Discipline_name AS 'Название', typeofdiscipline.Type_name AS 'Тип' FROM facultytimetable.discipline_group LEFT OUTER JOIN facultytimetable.discipline ON discipline.Discipline_ID = discipline_group.Discipline_ID JOIN facultytimetable.typeofdiscipline ON discipline.Type_ID = typeofdiscipline.Type_ID where discipline_group.Group_ID = @discGroupID";
        ...
        public static string selectCountGroups = "SELECT count(Group_ID) FROM facultytimetable.grouper";
        public static string selectCountRings = "SELECT count(Ring_ID) FROM facultytimetable.ring";
        public static string selectGroupNameWithAlias = "SELECT group_ID, group_name AS 'Группа' FROM facultytimetable.grouper";
        public static string selectGroupName = "SELECT group_name FROM facultytimetable.grouper";
        ...
        public static string insertGroup = "insert into facultytimetable.grouper (Group_name) values (@groupName)";
        ...
        public static string insertOneDisciplineForGroup = "insert into facultytimetable.discipline_group (Discipline_ID, Group_ID) values (@discID,@groupID)";
        ...
        public static string updateGroup = "update facultytimetable.grouper SET Group_name = @groupName where Group_ID = @groupID";
        ...
        public static string updateOneDisciplineForGroup = "update facultytimetable.discipline_group set Discipline_ID = @newDiscID where Group_ID = @groupID and Discipline_ID =@oldDiscID";
        #endregion
        ...
        public static string deleteGroup = "delete from facultytimetable.grouper where Group_ID = @groupID";
        ...
        public static string deleteOneDisciplineForGroup = "delete from facultytimetable.discipline_group where Discipline_ID = @discID and Group_ID = @groupID";
